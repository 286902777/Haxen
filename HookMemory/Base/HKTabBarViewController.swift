...
class HKTabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let vipNav = addChildVC(vc: HKPurchaseViewController(),title: TabBarItemTitle.premium.rawValue, image: "movie_premium", selectImage: "movie_premium_select")
        ...
        self.viewControllers = [homeNav, exploreNav, vipNav, setNav]
    }
